...
&nbsp;&nbsp;Так как работа велась в инженерной среде, первичная документация оформлялась в Excel, а затем мигрировала в **Qase.io** для трекинга прогонов.
...
&nbsp;&nbsp;На скриншоте ниже — пример оформления в Excel (который позже был перенесен в TMS).
