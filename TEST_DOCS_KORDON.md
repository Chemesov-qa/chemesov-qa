...
*   **Измеримые критерии приёмки:**<br>Ожидаемый результат - бинарный проверяемый факт. *«Задержка ≤ 5 сек»*, *«индикатор подсвечен красным»*<br>*«в логе запись без ошибок»* вместо абстрактного «работает корректно».
