...
> *Смотреть Mind-map* [🗺️ Посмотреть карту декомпозиции](./MAP/KORDON_MINDMAP_CASE.md)
> *Смотреть План / Test Plan* [🗺️ Посмотреть карту декомпозиции](./MAP/KORDON_MINDMAP_CASE.md)
