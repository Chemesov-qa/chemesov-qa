...
*На скриншоте видно, что часть проверок (например, регистрация проезда ТС) подсвечена красным — это сразу дало понять, что стенд к полноценному тестированию не готов и требует вмешательства инженеров.*

#### 📝 Детализированные тест-кейсы
...
**Ключевые сценарии, которые видны на скриншоте:**
...
Тестирование выявило ряд критических несоответствий. Я оформил баг-репорты так, чтобы разработчику не пришлось переспрашивать детали. Ниже — примеры самых значимых дефектов.
...
*Суть бага:* Пользователь с ролью «Оператор» имел техническую возможность удалять архивы данных. Это критическая уязвимость ролевой модели (RBAC), ведущая к риску несанкционированного уничтожения доказательной базы.
