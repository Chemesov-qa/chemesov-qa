...
Прогон выполнен через встроенный **Runner** Postman.<br>Статус: **✅ Все тесты пройдены успешно**.
...
![Визуальный отчет Newman](./images/POSTMAN_REPORT.png)

> **Скриншот 4** - Визуальный отчет Newman
