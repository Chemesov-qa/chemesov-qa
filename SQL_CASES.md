...
### Кейс №7: Проверить корректность логики фиксации превышений (например, не попадают ли в базу события со скоростью ниже порога + погрешность).
**Задача:** Проверить, что система не маркирует как нарушение автомобили, чья скорость находится в пределах погрешности измерения (+2 км/ч к лимиту).
