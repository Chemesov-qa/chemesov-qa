...
**Задача:** Проверить систему на наличие бага «Дублирование нарушений» - ситуации, когда из-за нестабильного сетевого сигнала один проезд фиксируется в базе дважды.
...
*   **Запрос:**
    ...
    HAVING COUNT(*) > 1;
    ```
*   **Что проверяем:** Уникальность каждой фиксации. Если запрос возвращает строки - это свидетельствует о дефекте в логике сохранения данных.
...
### Кейс №10: Проверка производительности
**Задача:** Быстрая сверка статистики за час для сравнения данных в UI-отчете и в «сырой» базе.
