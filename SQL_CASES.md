...
*   **Ожидаемый результат:**<br> Запрос возвращает ровно 1 строку с confidence_score > 0.8.<br> Если 0 строк — событие не сохранилось.<br> Если больше 1 — есть дублирование.<br>
