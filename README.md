...
| :--- | :--- | :--- | :---: |
| **Тестовая документация** | Проектирование тест-кейсов и чек-листов для ПАК «Кордон» | Jira, TestRail, MS Excel | [🔗 Перейти](./TEST_DOCS_KORDON.md) |
...
| **Test Summary Report** | Сводный отчет по итогам цикла тестирования с метриками | Allure, MS Word | [🔗 Перейти](./TEST_SUMMARY.md) |
