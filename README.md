...
<div>
  <ul>
    <li><strong>Теория тестирования:</strong> <strong>Понимание принципов, уровней, типов тестирования, SDLC/STLC, верификации/валидации, работа с требованиями. Знаком с основами ISTQB.</strong></li>
    <li><strong>Тест-дизайн:</strong> <strong>Применяю техники: эквивалентное разбиение, анализ граничных значений, попарное тестирование, диаграммы переходов состояний, таблицы принятия решений.</strong></li>
    <li><strong>Методологии разработки:</strong> <strong>Опыт работы в Agile (Scrum, Kanban), понимание ролей и процессов.</strong></li>
    <li><strong>Оценка трудозатрат:</strong> <strong>Применяю различные виды эстимации, работа с метриками и матрицей трассировки.</strong></li>
  </ul>
</div>
