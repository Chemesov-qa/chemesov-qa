...
|:------------:|:----------:|:-----------------:|:--------:|
| **Тестовая документация** | Проектирование тест-кейсов и чек-листов для системы «Кордон» | Jira, TestRail, MS Excel | [🔗 Перейти](#) |
| **API тестирование** | 	Автоматизированные коллекции тестов для REST и SOAP сервисов | Postman, Swagger | [🔗 Перейти](#) |
| **SQL запросы** |	Валидация данных и сложные выборки для проверки БД | MySQL | [🔗 Перейти](./SQL_CASES.md) |
| **Автоматизация** | Разработка автотестов для регрессионного тестирования системы «Кордон» | Python + Selenium | [🔗 Перейти](./SQL_CASES.md) |
