...
Все кейсы в этом разделе основаны на моём реальном опыте работы инженером -<br>Мой реальный опыт тестирования комплекса «Кордон»:<br>Это дорожные камеры<br>и серверное оборудование, которые автоматически фиксируют нарушения ПДД на перекрёстках и трассах,чтобы выписывать штрафы.<br>Моя задача была проверить новую прошивку на тестовых стендах и не допустить её установку на 47 боевых комплексов, так как ошибка могла привести к юридически недействительным штрафам.<br>Я подготовил всю тестовую документацию, нашёл критические баги и передал разработчикам детальный отчёт на доработку.
