...
| **Автоматизация** | Разработка автотестов для регрессионного тестирования ПАК «Кордон» | Python | [🔗 Перейти](./SQL_CASES.md) |
| **Mind-map** | Интеллект-карта проекта | Xmind | [🔗 Перейти](./MIND_MAP.md) |
| **План / Test Plan** | Стратегия тестирования ПАК «Кордон» | Markdown/MS Word | [🔗 Перейти](./TEST_PLAN_KORDON.md) |
| **Test Summary Report** | Отчет о результатах тестирования | Markdown/MS Word | [🔗 Перейти](./TEST_SUMMARY.md) |
