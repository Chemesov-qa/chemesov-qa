...
| :--- | :--- | :--- | :---: |
| **Тестовая документация** | Проектирование тест-кейсов и чек-листов для ПАК «Кордон» | Jira, TestRail, MS Excel | [🔗 Перейти](link) |
| **API тестирование** | Автоматизированные коллекции тестов для REST-сервисов | Postman, Swagger | [🔗 Перейти](link) |
| **SQL запросы** | Валидация данных и сложные выборки для проверки БД | MySQL, DBeaver | [🔗 Перейти](link) |
| **Автоматизация** | Разработка автотестов для регрессионного тестирования системы | Python + Selenium | [🔗 Перейти](link) |
| **Mind-map** | Визуализация стратегии покрытия и декомпозиция проекта | XMind | [🔗 Перейти](link) |
| **План / Test Plan** | Стратегия обеспечения качества и методология проверок | Markdown, Confluence | [🔗 Перейти](link) |
| **Test Summary Report** | Сводный отчет по итогам цикла тестирования с метриками | Allure, MS Word | [🔗 Перейти](link) |
