...
💡 **Теория тестирования:** Понимание принципов, уровней, типов тестирования, SDLC/STLC, верификации/валидации, работа с требованиями. Знаком с основами ISTQB.

💡 **Тест-дизайн:** Применяю техники: эквивалентное разбиение, анализ граничных значений, попарное тестирование, диаграммы переходов состояний, таблицы принятия решений.

💡 **Методологии разработки:** Опыт работы в Agile (Scrum, Kanban), понимание ролей и процессов.

💡 **Оценка трудозатрат:** Применяю различные виды эстимации, работа с метриками и матрицей трассировки.
