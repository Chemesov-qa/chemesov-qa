...
| **API тестирование** | 	Автоматизированные коллекции тестов для REST | Postman, Swagger | [🔗 Перейти](./API_TESTING_POSTMAN.md) |
| **SQL запросы** |	Валидация данных и сложные выборки для проверки БД | MySQL | [🔗 Перейти](./SQL_CASES.md) |
| **Автоматизация** | Автотесты для тестирования системы «Кордон» | Python + Selenium | [🔗 Перейти](./AUTOTESTS.md) |
