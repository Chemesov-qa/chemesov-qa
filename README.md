...
Все кейсы в этом разделе основаны на моём реальном опыте работы инженером -<br>

Мой реальный опыт тестирования комплекса «Кордон»:<br>Это дорожные камеры и серверное оборудование, которые автоматически<br>фиксируют нарушения ПДД на перекрёстках и трассах,чтобы выписывать штрафы.<br>

Моя задача была проверить новую прошивку на тестовых стендах.<br>Не допустить её установку на 47 боевых комплексов, так как ошибка могла привести к юридически недействительным штрафам.<br>

Я подготовил всю тестовую документацию, нашёл критические баги и передал разработчикам детальный отчёт на доработку.
