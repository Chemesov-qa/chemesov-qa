...
<div>
  <ul style="list-style-type: none; padding-left: 0; margin: 0;">
    <li style="margin-bottom: 8px;">💡 <strong>Теория тестирования:</strong> Понимание принципов, уровней, типов тестирования, SDLC/STLC, верификации/валидации, работа с требованиями. Знаком с основами ISTQB.</li>
    <li style="margin-bottom: 8px;">💡 <strong>Тест-дизайн:</strong> Применяю техники: эквивалентное разбиение, анализ граничных значений, попарное тестирование, диаграммы переходов состояний, таблицы принятия решений.</li>
    <li style="margin-bottom: 8px;">💡 <strong>Методологии разработки:</strong> Опыт работы в Agile (Scrum, Kanban), понимание ролей и процессов.</li>
    <li style="margin-bottom: 8px;">💡 <strong>Оценка трудозатрат:</strong> Применяю различные виды эстимации, работа с метриками и матрицей трассировки.</li>
  </ul>
</div>
