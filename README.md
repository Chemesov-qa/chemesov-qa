...
С 9-месячным опытом работы в крупной аккредитованной IT-компании 🚀

В мои задачи входила настройка, тестирование и отладка оборудования 🔧

Чтобы систематизировать знания, я прошел углубленный курс по основам тестирования от Artsiom Rusau 📙

Сейчас я в поиске интересного проекта, где смогу расти и развиваться как специалист 📈

В ближайших планах - углубленное изучение автоматизированного тестирования 📊
...
<div align="center">
  <table>
    <tr>
      <td align="center" style="background-color: #4CAF50; padding: 12px 24px; border-radius: 8px; color: white; font-weight: bold; transition: transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">🤝 Дружный коллектив</td>
      <td width="20"></td>
...
💡 **Теория тестирования**<br>
&nbsp;&nbsp;&nbsp;&nbsp;Понимание принципов, уровней, типов тестирования, SDLC/STLC, верификации/валидации, работа с требованиями.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Знаком с основами ISTQB.

<br>

💡 **Тест-дизайн**<br>
&nbsp;&nbsp;&nbsp;&nbsp;Применяю техники: эквивалентное разбиение, анализ граничных значений, попарное тестирование,<br>
&nbsp;&nbsp;&nbsp;&nbsp;диаграммы переходов состояний, таблицы принятия решений.

<br>

💡 **Методологии разработки**<br>
&nbsp;&nbsp;&nbsp;&nbsp;Опыт работы в Agile (Scrum, Kanban), понимание ролей и процессов.

<br>

💡 **Оценка трудозатрат**<br>
&nbsp;&nbsp;&nbsp;&nbsp;Применяю различные виды эстимации, работа с метриками и матрицей трассировки.
...
<div>
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jira/jira-original.svg" title="Jira" width="50" height="50"/>&nbsp
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/youtrack/youtrack-original.svg" title="YouTrack" width="50" height="50"/>&nbsp
  <img src="https://codahosted.io/packs/21236/unversioned/assets/LOGO/ba1091c59bab89cd2fd0f289622731fe16113d7b00905abe64759c313a4b73b76c1b0426076ed76cb74752234c734131df46992d5b8b48fc13e264240e4f7119f736cfeb64df36ded54b5cbf6198b9cadedf18dd0cac5c7dbcd16e6336c29363cd1292ba" title="TestRail" width="50" height="50"/>&nbsp
  <img src="https://luna1.co/eb0187.png" title="QASE" width="50" height="50"/>&nbsp
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/testlink/testlink-original.svg" title="TestIT" width="50" height="50"/>&nbsp
</div>
...
<div>
  <table>
    <tr>
      <td align="center">💬</td>
      <td><strong>Коммуникабельность</strong><br>Легко нахожу общий язык с коллегами и заказчиками</td>
      <td width="40"></td>
      <td align="center">🤝</td>
      <td><strong>Работа в команде</strong><br>Эффективно взаимодействую в кросс-функциональных командах</td>
    </tr>
    <tr>
      <td align="center">🎯</td>
      <td><strong>Прагматичность</strong><br>Принимаю решения, основанные на фактах и приоритетах</td>
      <td></td>
      <td align="center">🔍</td>
      <td><strong>Внимательность к деталям</strong><br>Замечаю нюансы, которые могут ускользнуть от других</td>
    </tr>
    <tr>
      <td align="center">📚</td>
      <td><strong>Стремление к обучению</strong><br>Постоянно расширяю свой технический кругозор</td>
      <td></td>
      <td align="center">⚡</td>
      <td><strong>Обучаемость</strong><br>Быстро осваиваю новые инструменты и технологии</td>
    </tr>
    <tr>
      <td align="center">🧠</td>
      <td><strong>Аналитическое и критическое мышление</strong><br>Умею структурировать информацию и находить неочевидные решения</td>
      <td></td>
      <td align="center">💪</td>
      <td><strong>Стрессоустойчивость и усидчивость</strong><br>Сохраняю продуктивность в сложных ситуациях</td>
    </tr>
  </table>
</div>
...
|:------------:|:----------:|:-----------------:|:--------:|
| **Тестовая документация** | Проектирование тест-кейсов и чек-листов для системы «Кордон» | Jira, TestRail, MS Excel | [🔗 Перейти](./TEST_DOCS_KORDON.md) |
| **API тестирование** | 	Автоматизированные коллекции тестов для REST и SOAP сервисов | Postman, Swagger | [🔗 Перейти](./API_TESTING_POSTMAN.md) |
| **SQL запросы** |	Валидация данных и сложные выборки для проверки БД | MySQL | [🔗 Перейти](./SQL_CASES.md) |
| **Автоматизация** | Автотесты для регрессионного тестирования системы «Кордон» | Python + Selenium | [🔗 Перейти](./AUTOTESTS.md) |
| **Mind-map** | Интеллект-карта проекта | Xmind | [🔗 Перейти](./MIND_MAP.md) |
| **План / Test Plan** | 	Стратегия обеспечения качества ПАК «Кордон» | Markdown/MS Word | [🔗 Перейти](./TEST_PLAN_KORDON.md) |
| **Test Summary Report** | Сводный отчет по итогам цикла тестирования с метриками | Markdown/MS Word | [🔗 Перейти](./TEST_SUMMARY.md) |
...
| Уровень профессионального обучения | Специализация | Год окончания |
|:-----------------------------------:|:---------------:|:-------------:|
| Высшее образование I степени (Бакалавриат) | Прикладная информатика | 2019 |
...
> Работая в компании, я активно участвовал в жизни организации, брал на себя дополнительные задачи, занимался обучением новых сотрудников и разработкой методических указаний.

---

### 🌟 О себе, увлечения, цели и планы

Люблю активный отдых, видеоигры, интересные места и поездки.

**Моя главная цель** — стать лучшим в своём деле, и я сделаю всё возможное, чтобы добиться поставленной цели.
<td>В планах — углублённое изучение автоматизированного тестирования и получение международной сертификации ISTQB.
